This file should remain unchanged, it was the original planned document prior to working on a better structured github repository. It is kept as a reference incase things are destroyed in other files.
