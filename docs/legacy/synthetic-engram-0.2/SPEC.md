...
> [!NOTE]
> This is the preserved legacy 0.2 package specification. Current Engram Mesh
> design work is in the repository-root [`SPEC.md`](../../../SPEC.md). Engram Mesh 0.3
> does not alter this contract or imply compatibility with it.
...
A future [Archive Binding Specification](archive-binding.md) will define
...
See [legacy conformance guidance](conformance.md) for the testable checklist.

## 12. Versioning

`version` has three numeric components and follows the pre-1.0 policy in
[legacy versioning policy](versioning.md). In the pilot series, a new minor
...
for the future [Archive Binding Specification](archive-binding.md).
